...
If you discover a security vulnerability in `@younndai/yon-textmate`, please
...
The latest released minor of `@younndai/yon-textmate` is supported. Security
fixes land on the current release line; older lines are upgraded forward
rather than back-patched unless otherwise noted in an advisory.
